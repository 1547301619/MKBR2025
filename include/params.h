...
const int q_boot = MKHEParams::Q_static; 
...
class Param
{
    public:
        ...
        const static int N = MKHEParams::N_static; //----------------
        ...
        constexpr static double e_st_dev = 1.9;
        ...
        void init()
        {
            if (scheme_type == SchemeType::LWE)
            {

                         
                q_base=MKHEParams::q_static;
                n=500;
                B_bsk[0] = 512;
                B_bsk[1] = 512;
                shift_bsk[0] = 9;
